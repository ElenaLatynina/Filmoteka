export function createMarkup(movies)
{
    ...
    <img class="examples__link" src="${poster_path}" alt="${original_title}" width="395px" height="574px">
    ...
    <div class="examples__content">
        <h2 class="examples__name">${original_title}</h2>
        <p class="examples__type">${genres.name}</p>
        <p class="examples__year">${production_countries.release_date}</p>
    </div>
    </a>
    </li> `;
    }).join('');
